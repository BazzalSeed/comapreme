...
export function LorePanel({ lore }: { lore: LoreBite[] }) {
  return (
    <section className="w-full bg-[#1a1410] py-14">
      <div className="mx-auto w-full max-w-4xl px-4">
        <Reveal>
          <h2 className="font-display text-center text-3xl text-[var(--gold)] mb-2">Dragon lore</h2>
          <p className="text-center text-[#cbb98e] mb-8 font-medium">
            What it actually means to be a dragon 🐲
          </p>
        </Reveal>
